  ...
  return (
    <div>
      ...
      <Description
        companyName={"iwoca"}
        projectName={"Quotes"}
        description={"Providing choice, early on."}
      />
      <Heading>The problem</Heading>
      <SpacerSmall />
      <Callout>
        A customer applying for financing has no indication of what options are
        available
      </Callout>
      <SpacerSmall />
      <Paragraph>
        Currently, a customer applying for financing has no indication of what
        options are available, or what they might be eligible for, until they
        have completed a full application.
      </Paragraph>
      <SpacerSmall />
      <Paragraph>
        Additionally, the online signup only presents the Flexi-loan, which
        means customers are never exposed to the other products unless they
        contact someone or search the website.
      </Paragraph>
      <SpacerLarge />
      <SingleImage
      mobilePosition={""}
      ...
      <SpacerSmall />
      <Paragraph>
        More customers will be willing to apply knowing what they are eligible
        for and how much it will cost. Fewer customers will drop-off if the
        quote matches the final offer - and by providing choice, we can serve
      ...
      <SpacerMedium />
      <Paragraph>
        The decline does not reflect the first funding increase across Funding
        Options portfolio (+13.1%) - we believe we lost share to just Cashflow
        and Esme, in part because they give customers instant, accurate quotes.
      </Paragraph>
      <SpacerSmall />
      <Paragraph>
        Think Business: “it's about providing the customer certainty as early as
        possible”
      </Paragraph>
      <SpacerLarge />
      <BulletAndImage
        ...
        paragraphOne={
          "Our customers receive no feedback until after entering all their personal and company details, and many would have to upload documents before any indication. The customer will be able to know within three questions if they should continue."
        }
        headingTwo={"➋ Speed and transparency"}
        paragraphTwo={
          "The customer now has several points of feedback and additional ‘what next’ explanations. The speed is improved vastly because they now get product offerings before submitting documentation"
        }
        headingThree={"➌ Offer indicators"}
        paragraphThree={
          "The customer will be able to know the exact price + limits before having to submit documents. They will have a detailed understanding of how each product works."
        }
        headingFour={"➍ Distinct and tailored products"}
        paragraphFour={
          "The customer will be able to understand how our products fit different needs, that the price isn’t just for the amount that you borrow and to make the selection easy and calculator-less and pain-less."
        }
      ...
      <SpacerSmall />
      <Paragraph>
        Loans are difficult to imagine in real-life as tangible products. By
        representing them as an experience using paper-feel details it relates
        finance to the world we live in - creating the impression of an
        experience.
      </Paragraph>
      <SpacerMedium />
      ...
      <Paragraph>
        Not only is it affordable, it’s free to repay early.
      </Paragraph>
      <SpacerXSmall />
      ...
      <SpacerSmall />
      <Paragraph>
        I created custom iwoca loan illustrations and visualisations to
        demonstrate how the loans work and which use cases they’re suitable for.
        iwoca is a team of talented and quirky individuals who see small
        businesses as people first and foremost - we wanted to design human and
        joyful experiences.
      </Paragraph>
      <Heading>Testing</Heading>
      <SpacerSmall />
      <Paragraph>
        Participants rated the memorability of the products 4 / 5 & they valued
        the well-thought out copy 'I actually think the text is really good and
        communicated very well' and 'the text was really well put together'.
      </Paragraph>
      <SpacerSmall />
      <SubHeading>What do you think about the options presented?</SubHeading>
      <SpacerXSmall />
      <Paragraph>
        Users were surprised, but reacted positively, to have a final offer
      ...
      <SpacerSmall />
      <Paragraph>
        After implementaton there was a significant increase in both conversion
