...
const Buyerupgrades = () => {
  return (
    <div>
      ...
      <Paragraph>Keep it simple and straightforward, no distractions. Focus on the merchant & the order, not the payments provider.</Paragraph><SpacerSmall/>
      <SubHeading>max automated</SubHeading><SpacerSmall/>
      <Paragraph>Balance uses Open Banking to auto-assess the business and pre-fill information. We currently only use OB for instant transactions.</Paragraph><SpacerSmall/>  
      <SubHeading>Single page process</SubHeading><SpacerSmall/>
      ...
      <Quote>"I don't like owing people money and I don't like a paying interest unless I need to."</Quote><SpacerSmall/>
      ...
      <Heading>Release One</Heading><SpacerMedium/>
      <SubHeading>01 no forced account creation</SubHeading><SpacerSmall/>
      <Paragraph>Email friction is the 2nd top reason for all checkout abandonment. By exposing the email input, we’re not overwhelming users before they’ve made their choice.</Paragraph><SpacerMedium/>  
      <SubHeading>02 exposing pay later</SubHeading><SpacerSmall/>
      <Paragraph>On the old version of the checkout, the user had to click on the Pay Later option to see any of the benefits. In the new design we’ve exposed and brought attention to the value of Pay Later.</Paragraph><SpacerMedium/> 
      <SubHeading>03 new copy</SubHeading><SpacerSmall/>
      <Paragraph>Instead of Pay Later which is less common in B2B (as invoices already by default allow this option) we’ve highlighted the fact the payment is split into smaller chunks</Paragraph><SpacerMedium/>
      <SubHeading>04 visual explanation of pay later</SubHeading><SpacerSmall/> 
      <Paragraph>We’ve made the visual more appealing and highlighted that the user pays £0 today, which was never clear in the old design.</Paragraph><SpacerMedium/>  
      <SubHeading>05 modularity</SubHeading><SpacerSmall/>  
      <Paragraph>The new layout allows us the flexibility of removing or adding new payment options more easily.</Paragraph> 
      <SubHeading>06 security & trust</SubHeading><SpacerSmall/>
      <Paragraph>Less iwocaPay branding, and removal of the trustpilot review (it was highly unusual for a payment provider to show a review).</Paragraph><SpacerSmall/> 
      <Paragraph>We’ve removed the small print about interest and added this information to the main copy.</Paragraph><SpacerSmall/>
      <Paragraph>Instead a small discrete padlock with the messaging ‘secure payments’ is added beneath the CTA.</Paragraph><SpacerMedium/>
      <SubHeading>07 Exit Screen</SubHeading><SpacerSmall/>
